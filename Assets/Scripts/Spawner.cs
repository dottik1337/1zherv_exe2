...
public class Spawner : MonoBehaviour
{
    ...
    public float spawnFrequencyMeanMin = 0.5f;
    public float spawnFrequencyMeanMax = 3.0f;
    ...
    void Update()
    {
        ...
        { // Check if we should spawn.
            ...
            { // Spawn at most one obstacle per frame.
                ...
                spawnFrequencyMean = Random.Range(spawnFrequencyMeanMin, spawnFrequencyMeanMax);
                nextSpawnIn = RandomNormal(spawnFrequencyMean, spawnFrequencyStd);
                Console.WriteLine($"{spawnFrequencyMean}");
                SpawnObstacle();
            }
        }
    }
